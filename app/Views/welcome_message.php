...
<body>
	...
	<header>
		...
		<div class="heroe">
			...
			<h1 class="align-center">CONSULTA DE DATOS PERSONALES</h1>
	...
	<section>
		...
		<h1>Ingrese el número de cédula</h1>

		<div class="input">
			<input type="text" id="txtCedula" value="">
	...
	<script>
		...
		$("#btnConsultar").click(function() {
			...
			var consulta = document.getElementById("txtCedula").value;
			if (consulta == "") {
				alert("Debe ingresar un número de cédula correcto");
				return;
			}
			$.get("empleado/" + consulta, function(data, status) {
				alert("El usuario es: " + data[0].nombre + " " + data[0].apellido);
			})
		});
